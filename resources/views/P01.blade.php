                ...
                <div class="row gx-5 ">
                    <div class="col-xxl-7" id="infoP">
                        ...
                        <div class="text-center text-xxl-start">
                            <h1 class=" fw-bolder mb-5"><span class="text-gradient d-inline" style="text-decoration:underline ;">PAKET P01</span>
                            </h1>
                            <div class="fs-4 fw-light text-muted fw-bold"><p>Paket PV01 mengutamakan Motif dan view yang lebih daripada paket lainnya, Menggunakan bahan sebagai berikut:</p>
                                <li>PVC LEGOES 8mm</li>
                                <li>Furing Star 0.35mm</li>
                                <li>Profil Gnet</li>
                                </div>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                <img class="paket-img" src="{{ URL::to('/assets/images/P01.jpg') }}" alt="..." />
                            </div>
                        </div>
                        <!-- About Section-->
                        <div class="infoPaket">
