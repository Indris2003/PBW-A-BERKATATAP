                ...
                <div class="row gx-5 ">
                    <div class="col-xxl-7" id="infoP">
                        ...
                        <div class="text-center text-xxl-start">
                            <h1 class=" fw-bolder mb-5"><span class="text-gradient d-inline" style="text-decoration:underline ;">PAKET P02</span>
                            </h1>
                            <div class="fs-4 fw-light text-muted fw-bold"><p>Paket PV02 menggunakan Semi Motif dan view yang cukup menarik, Menggunakan bahan sebagai berikut:</p>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                <img class="paket-img" src="{{ URL::to('/assets/images/P02.jpg') }}" alt="..." />
                            </div>
                        </div>
                        <!-- About Section-->
                        <div class="infoPaket">
