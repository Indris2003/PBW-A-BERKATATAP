                ...
                <div class="row gx-5 ">
                    <div class="col-xxl-7" id="infoP">
                        ...
                        <div class="text-center text-xxl-start">
                            <h1 class=" fw-bolder mb-5"><span class="text-gradient d-inline" style="text-decoration:underline ;">PAKET A01</span>
                            </h1>
                            <div class="fs-4 fw-light text-muted fw-bold"><p>Paket A01 mengutamakan kualatias
                                yang lebih daripada paket lainnya, 
                                Menggunakan bahan bahan sebagai
                                berikut:</p>
                                <li>Kanal TASO C75/0.75</li>
                                <li>Reng TASO 0.45</li>
                                <li>StarDex Type 700/0.35mm</li>
                                </div>
                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                <img class="paket-img" src="{{ URL::to('/assets/images/atap001.jpg') }}" alt="..." />
                            </div>
                        </div>
                        <!-- About Section-->
                        <div class="infoPaket">
