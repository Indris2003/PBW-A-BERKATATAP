...
<body class="d-flex flex-column min-vh-100">
    <main class="flex-shrink-0">
        ...
        <h2 class="fw-bolder" style="margin:25px; margin-bottom: 25px;" ><span class="text-gradient d-inline" style="text-decoration:underline;">PAKET PARTISI</span></h2><br>
            <div class="row">
                <div class="col-sm-4">
                    <img src="{{ URL::to('/assets/images/atap001.jpg') }}" class="img-responsive" style="width:100%; margin:10px;" alt="Image">
                    <a class="btn btn-outline-dark btn-lg px-5 py-2 fs-10 fw-bolder" href="A01">Paket G01</a>
                </div>
                <div class="col-sm-4"> 
                    <img src="{{ URL::to('/assets/images/atap002.jpg') }}" class="img-responsive" style="width:100%; margin: 10px;" alt="Image">
                    <a class="btn btn-outline-dark btn-lg px-5 py-2 fs-10 fw-bolder" href="A02">Paket G02</a>
                </div>
                <div class="col-sm-4"> 
                    <img src="{{ URL::to('/assets/images/atap003.jpg') }}" class="img-responsive" style="width:100%; margin: 10px;" alt="Image">
                    <a class="btn btn-outline-dark btn-lg px-5 py-2 fs-10 fw-bolder" href="A03">Paket G03</a>
                </div>
            </div>
        </div>
        <!-- <br>/ -->
